...
class AppPages {
  static final routes = [
    ...
    GetPage(
        name: Routes.AUTH_HUB,
        page: () => const AuthHubView(),
        binding: AuthBinding()),
    GetPage(
        name: Routes.LOGIN, page: () => const LoginView(), binding: AuthBinding()),
    GetPage(
        name: Routes.SIGNUP,
    ...
    GetPage(
        ...
        binding: AuthBinding()),
    GetPage(
        name: Routes.GUEST_MODE,
        page: () => const GuestModeView(),
        binding: AuthBinding()),
    ...
    // GROUPS
    GetPage(
        name: Routes.GROUPS_LIST,
        page: () => const GroupsListView(),
        binding: GroupBinding()),
    GetPage(
        name: Routes.GROUP_DASHBOARD,
        page: () => const GroupDashboardView(),
        binding: GroupDashboardBinding()),
    GetPage(
        name: Routes.MEMBERS_PERMISSIONS,
        page: () => const MembersPermissionsView(),
    ...
    GetPage(
        name: Routes.RECURRING_EXPENSE,
        page: () => const RecurringExpenseView(),
        binding: RecurringExpenseBinding()),
